...
/**
 * Class TeacherUpdatePublicAliasCommand.
 */
class TeacherUpdatePublicAliasCommand extends Command
{
	/**
	 * @var string Command Name
	 */
	protected $name = "teacher_update_public_alias";
	
	/**
	 * @var string Command Description
	 */
	protected $description = "Update public alias of active teacher.";
