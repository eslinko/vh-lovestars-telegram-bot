...
/**
 * Class TeacherUpdateDescriptionCommand.
 */
class TeacherUpdateDescriptionCommand extends Command
{
	/**
	 * @var string Command Name
	 */
	protected $name = "teacher_update_description";
	
	/**
	 * @var string Command Description
	 */
	protected $description = "Update description of active teacher.";
